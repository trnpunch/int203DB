...
public class Student2 extends javax.swing.JFrame {
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        s.setsId(Integer.parseInt(username.getText()));
        s.setDob(password.getText());
        int id = s.getsId();
        String pass = s.getDob();
        s = Student.findById(id, pass);
        ...
        p.setVisible(true);
        this.dispose();
               //JOptionPane.showMessageDialog(rootPane, cust2);
            ...
            System.out.println("error students gui");
        }
